...
#pragma location=0xD0e00000
static __no_init uint8_t front_buffer[VIZ_WIDTH * VIZ_HEIGHT];

#elif defined ( __CC_ARM ) /* !< Keil Compiler */
uint8_t front_buffer[VIZ_WIDTH * VIZ_HEIGHT] __attribute__((at(0xD0e00000)));

#elif defined ( __GNUC__ ) /* !< GNU Compiler */
uint8_t front_buffer[VIZ_WIDTH * VIZ_HEIGHT] __attribute__((__section__(".front_buffer_section")));
#endif

#if defined ( __ICCARM__ ) /* !< IAR Compiler */
#pragma location=0xD0e0FA00
static __no_init uint8_t back_buffer[VIZ_WIDTH * VIZ_HEIGHT];

#elif defined ( __CC_ARM ) /*!< Keil Compiler */
uint8_t back_buffer[VIZ_WIDTH * VIZ_HEIGHT] __attribute__((at(0xD0e0FA00)));

#elif defined ( __GNUC__ ) /* !< GNU Compiler */
int8_t back_buffer[VIZ_WIDTH * VIZ_HEIGHT] __attribute__((__section__(".back_buffer_section")));
#endif

#if defined ( __ICCARM__ ) /* !< IAR Compiler */
#pragma location=0xD0e1F400
static __no_init int16_t deform_offset_x[VIZ_WIDTH * VIZ_HEIGHT];

#elif defined ( __CC_ARM ) /*!< Keil Compiler */
int16_t deform_offset_x[VIZ_WIDTH * VIZ_HEIGHT] __attribute__((at(0xD0e1F400)));

#elif defined ( __GNUC__ ) /* !< GNU Compiler */
int16_t deform_offset_x[VIZ_WIDTH * VIZ_HEIGHT] __attribute__((__section__(".deform_offset_x_section")));
#endif

#if defined ( __ICCARM__ ) /* !< IAR Compiler */
#pragma location=0xD0e7D000
static __no_init int16_t deform_offset_y[VIZ_WIDTH * VIZ_HEIGHT];

#elif defined ( __CC_ARM ) /*!< Keil Compiler */
int16_t deform_offset_y[VIZ_WIDTH * VIZ_HEIGHT] __attribute__((at(0xD0e7D000)));

#elif defined ( __GNUC__ ) /* !< GNU Compiler */
int16_t deform_offset_y[VIZ_WIDTH * VIZ_HEIGHT] __attribute__((__section__(".deform_offset_y_section")));
#endif
...
void visualization_initialize(void)
{
  current_effect = 3;
#ifdef VIZ_WORKSPACE_IN_SDRAM
#define OFFSET 0xA00000
  front_buffer = (uint8_t*)(0xD0000000 + OFFSET);
