...
#pragma location=0x10007000
uint8_t AudioBuffer[AUDIO_BUFFER_SIZE + 8];

#elif defined ( __CC_ARM ) /* !< Keil Compiler */
uint8_t AudioBuffer[AUDIO_BUFFER_SIZE + 8] __attribute__((at(0x10007000)));

#elif defined ( __GNUC__ ) /* !< GNU Compiler */
uint8_t AudioBuffer[AUDIO_BUFFER_SIZE + 8] __attribute__((__section__(".Audio_buffer_section")));
#endif
