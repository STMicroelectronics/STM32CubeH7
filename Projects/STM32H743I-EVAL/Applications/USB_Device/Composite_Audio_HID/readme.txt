/**
  @page Composite USB Device Composite Audio HID application

  @verbatim
  ******************** (C) COPYRIGHT 2021 STMicroelectronics *******************
  * @file    USB_Device/Composite_Audio_HID/readme.txt
...
enumerated as a composite device containing 2 functions:
    ...
    1 HID functions: This is a typical application on how to use the STM32H743xx USB OTG Device peripheral where the STM32 MCU is
...
Connectivity, USB_Device, USB, SAI, Audio, Streaming, Full speed, PCM, HID, Joystick, Button, Remote Wakeup

@par Directory contents

  - /Src/main.c                  Main program
  - /Src/system_stm32h7xx.c      STM32H7xx system clock configuration file
  - /Src/stm32h7xx_it.c          Interrupt handlers
  - /Src/usbd_audio_if.c         USBD Audio interface
  - /Src/usbd_conf.c             General low level driver configuration
  - /Src/usbd_desc.c             USB device AUDIO descriptor
  ...
  - /Inc/usbd_conf.h             USB device driver Configuration file
  - /Inc/usbd_desc.h             USB device AUDIO descriptor header file
  - /Inc/usbd_audio_if.h         USBD Audio interface header file
