/**
  @page Composite USB Device Composite CDC HID application

  @verbatim
  ******************** (C) COPYRIGHT 2021 STMicroelectronics *******************
  * @file    readme.txt
  * @author  MCD Application Team
  * @brief   Description of the USB Composite CDC HID application.
  ******************************************************************************
  * @attention
  *
...
use USB device application based on the CDC CDC HID composite device on the STM32H743xx devices.
...
enumerated as a composite device containing 2 functions:
    ...
    1 HID function: This is a typical application on how to use the STM32H743xx USB OTG Device peripheral where the STM32 MCU 			  	    is enumerated as a HID device using the native PC Host HID driver to which the STM32H743I-EVAL
...
All following functions can be used simultaneously:
...
@note To use CDC first instance USE_CDC_INSTANCE_1 should be defined. To use second CDC instance 
USE_CDC_INSTANCE_1 should not be defined.
...
Connectivity, USB_Device, USB, HID, Full Speed, High Speed, Joystick, Mouse, OTG, UART, CDC, USB-to-RS232, Bridge, VCP, Com port

@par Directory contents

  - USB_Device/Composite_CustomHID_CDC/Src/main.c                  Main program
  - USB_Device/Composite_CustomHID_CDC/Src/system_stm32h7xx.c      STM32h7xx system clock configuration file
  - USB_Device/Composite_CustomHID_CDC/Src/stm32h7xx_it.c          Interrupt handlers
  - USB_Device/Composite_CustomHID_CDC/Src/stm32h7xx_hal_msp.c     HAL MSP module
  - USB_Device/Composite_CustomHID_CDC/Src/usbd_conf.c             General low level driver configuration
  - USB_Device/Composite_CustomHID_CDC/Src/usbd_desc.c             USB device descriptor
  - USB_Device/Composite_CustomHID_CDC/Src/usbd_cdc_interface.c    USBD CDC interface
  - USB_Device/Composite_CustomHID_CDC/Inc/main.h                  Main program header file
  - USB_Device/Composite_CustomHID_CDC/Inc/stm32h7xx_it.h          Interrupt handlers header file
  - USB_Device/Composite_CustomHID_CDC/Inc/stm32hxx_hal_conf.h     HAL configuration file
  - USB_Device/Composite_CustomHID_CDC/Inc/usbd_conf.h             USB device driver Configuration file
  - USB_Device/Composite_CustomHID_CDC/Inc/usbd_desc.h             USB device descriptor header file
  - USB_Device/Composite_CustomHID_CDC/Inc/usbd_cdc_interface.h    USBD CDC interface header file
