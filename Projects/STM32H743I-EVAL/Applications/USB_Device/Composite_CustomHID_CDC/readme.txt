/**
  @page Composite USB Device Composite Custom HID CDC application

  @verbatim
  ******************** (C) COPYRIGHT 2021 STMicroelectronics *******************
  * @file    USB_Device/Composite CustomHID CDC/readme.txt
  * @author  MCD Application Team
  * @brief   Description of the USB Composite Custom HID CDC application.
  ******************************************************************************
  * @attention
  *
...
use USB device application based on the CustomHID CDC composite device on the STM32H743xx devices.
...
enumerated as a composite device containing 2 functions:
    ...
    1 CustomHID function: A typical application on how to use the STM32H743xx USB OTG Device peripheral, where the STM32 MCU is
...
      Please refer to the AN4839 "Level 1 cache on STM327 Series"
