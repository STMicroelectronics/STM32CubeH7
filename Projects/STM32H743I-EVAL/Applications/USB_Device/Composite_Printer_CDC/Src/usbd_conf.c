...
USBD_StatusTypeDef USBD_LL_Init(USBD_HandleTypeDef *pdev)
{
  ...
  hpcd_USB_FS.Instance = USB2_OTG_FS;
  ...
  (void)HAL_PCDEx_SetTxFiFo(&hpcd_USB_FS, 1, 0x80);
  (void)HAL_PCDEx_SetTxFiFo(&hpcd_USB_FS, 2, 0x40);
  (void)HAL_PCDEx_SetTxFiFo(&hpcd_USB_FS, 3, 0x80);
#endif
  ...
  (void)HAL_PCDEx_SetTxFiFo(&hpcd_USB_HS, 0, 0x80);
  (void)HAL_PCDEx_SetTxFiFo(&hpcd_USB_HS, 1, 0x80);
  (void)HAL_PCDEx_SetTxFiFo(&hpcd_USB_HS, 2, 0x100);
  (void)HAL_PCDEx_SetTxFiFo(&hpcd_USB_HS, 3, 0x100);
