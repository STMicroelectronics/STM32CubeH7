...
#define USBD_PID                      0xC20
#define USBD_LANGID_STRING            0x409
#define USBD_MANUFACTURER_STRING      "STMicroelectronics"
#define USBD_PRODUCT_HS_STRING        "Composite CDC PRNT Class in HS Mode"
#define USBD_PRODUCT_FS_STRING        "Composite CDC PRNT Class in FS Mode"
#define USBD_CONFIGURATION_HS_STRING  "Composite CDC PRNT Config"
#define USBD_INTERFACE_HS_STRING      "Composite CDC PRNT Interface"
#define USBD_CONFIGURATION_FS_STRING  "Composite CDC PRNT Config"
#define USBD_INTERFACE_FS_STRING      "Composite CDC PRNT Interface"
