## LwIP_TFTP_Server Application Description
...
#### Notes
 1. Please insure that the uSD is plugged before starting, this application doesn't handle hot plug/unplug of the uSD card
