    ...
    flexButtonCallback(this, &ExtractorHoodScreenViewBase::flexButtonCallbackHandler)
{
    ...
    background.setBitmap(Bitmap(BITMAP_AIRCONTROL_BG_ID));

    buttoKitchen.setXY(15, 15);
    buttoKitchen.setBitmaps(Bitmap(BITMAP_HOMEBTN_ID), Bitmap(BITMAP_HOMEBTN_ID));
    buttoKitchen.setAction(buttonCallback);

    fanBg.setXY(121, 0);
    fanBg.setBitmap(Bitmap(BITMAP_FAN_BG_ID));

    gitter.setXY(143, 16);
    gitter.setBitmap(Bitmap(BITMAP_GITTER_ID));
