    ...
    updateItemCallback(this, &BathtubScreenViewBase::updateItemCallbackHandler)
{
    ...
    background.setBitmap(Bitmap(BITMAP_BATHTUB_UI_BG_ID));

    buttonBathroom.setXY(0, 0);
    buttonBathroom.setBitmaps(Bitmap(BITMAP_TOP_GO_BACK_ID), Bitmap(BITMAP_TOP_GO_BACK_ID));
    ...
    imageTempWheelBg.setBitmap(Bitmap(BITMAP_TEMPERATURE_BG_ID));
    containerTempWheel.add(imageTempWheelBg);

    imageSelectedTempMarker.setXY(0, 90);
    imageSelectedTempMarker.setBitmap(Bitmap(BITMAP_GRADIENT_CENTER_ID));
    ...
    scrollWheelTemperature.setEasingEquation(EasingEquations::backEaseOut);
    ...
    imageTempWheelGradient.setBitmap(Bitmap(BITMAP_GRADIENT_OVERLAY_ID));
    containerTempWheel.add(imageTempWheelGradient);

    toggleButtonTempUnit.setXY(13, 29);
    toggleButtonTempUnit.setBitmaps(Bitmap(BITMAP_F_ON_ID), Bitmap(BITMAP_C_ON_ID));
    ...
    imageWheelSelectTemp.setXY(-173, 91);
    imageWheelSelectTemp.setBitmap(Bitmap(BITMAP_WHEEL_SELECT_TOP_ID));
    containerTempWheel.add(imageWheelSelectTemp);

    containerLightColor.setPosition(480, 64, 146, 196);

    imageColorWheel.setXY(0, 1);
    imageColorWheel.setBitmap(Bitmap(BITMAP_LIGHTCOLOR_BG_ID));
    containerLightColor.add(imageColorWheel);

    imagePicker.setXY(53, 102);
    imagePicker.setBitmap(Bitmap(BITMAP_LIGHTCOLOR_SELECTOR_DOT_ID));
    containerLightColor.add(imagePicker);

    toggleButtonLight.setXY(13, 28);
    toggleButtonLight.setBitmaps(Bitmap(BITMAP_LIGHTOFF_ID), Bitmap(BITMAP_LIGHTON_ID));
    ...
    imageJetWheelBg.setBitmap(Bitmap(BITMAP_JETS_BG_ID));
    containerJetControl.add(imageJetWheelBg);

    imageSelectedJetSpeedMarker.setXY(0, 90);
    imageSelectedJetSpeedMarker.setBitmap(Bitmap(BITMAP_GRADIENT_CENTER_ID));
    ...
    scrollWheelJetSpeed.setEasingEquation(EasingEquations::backEaseOut);
    ...
    imageJetSpeedWheelGradient.setBitmap(Bitmap(BITMAP_GRADIENT_OVERLAY_ID));
    containerJetControl.add(imageJetSpeedWheelGradient);

    toggleButtonJetSpeed.setXY(13, 29);
    toggleButtonJetSpeed.setBitmaps(Bitmap(BITMAP_LIGHTOFF_ID), Bitmap(BITMAP_LIGHTON_ID));
    toggleButtonJetSpeed.setAction(buttonCallback);
    containerJetControl.add(toggleButtonJetSpeed);

    imageWheelSelectJet.setXY(-3, 91);
    imageWheelSelectJet.setBitmap(Bitmap(BITMAP_WHEEL_SELECT_TOP_ID));
    containerJetControl.add(imageWheelSelectJet);

    toggleButtonPower.setXY(410, 0);
    toggleButtonPower.setBitmaps(Bitmap(BITMAP_POWER_ICON_ID), Bitmap(BITMAP_POWER_ICON_ID));
    toggleButtonPower.setAction(buttonCallback);

    topBarButtonsContainer.setPosition(81, -60, 317, 60);

    radioButtonLight.setXY(217, 0);
    radioButtonLight.setBitmaps(Bitmap(BITMAP_LIGHT_OFF_ID), Bitmap(BITMAP_LIGHT_OFF_ID), Bitmap(BITMAP_LIGHT_ON_ID), Bitmap(BITMAP_LIGHT_ON_ID));
    ...
    radioButtonJets.setBitmaps(Bitmap(BITMAP_JETS_OFF_IMG_ID), Bitmap(BITMAP_JETS_OFF_IMG_ID), Bitmap(BITMAP_JETS_ON_IMG_ID), Bitmap(BITMAP_JETS_ON_IMG_ID));
    ...
    radioButtonTemperature.setBitmaps(Bitmap(BITMAP_TEMP_OFF_ID), Bitmap(BITMAP_TEMP_OFF_ID), Bitmap(BITMAP_TEMP_ON_ID), Bitmap(BITMAP_TEMP_ON_ID));
    ...
    imageWater.setBitmap(Bitmap(BITMAP_BATHTUB_WATER_ID));

    imageBathtubFront.setXY(0, 162);
    imageBathtubFront.setBitmap(Bitmap(BITMAP_BATHTUB_OVERLAY_ID));
...
void BathtubScreenViewBase::updateItemCallbackHandler(DrawableListItemsInterface* items, int16_t containerIndex, int16_t itemIndex)
{
