...
FanKnobBase::FanKnobBase()
{
    ...
    imageKnob.setXY(0, 0);
    imageKnob.setBitmap(Bitmap(BITMAP_SPPED_KNOB_ID));
    ...
    Unicode::snprintf(textAreaKnobBuffer, TEXTAREAKNOB_SIZE, "%s", TypedText(T_SINGLEUSEID46).getText());
    textAreaKnob.setWildcard(textAreaKnobBuffer);
    textAreaKnob.setTypedText(TypedText(T_SINGLEUSEID45));
