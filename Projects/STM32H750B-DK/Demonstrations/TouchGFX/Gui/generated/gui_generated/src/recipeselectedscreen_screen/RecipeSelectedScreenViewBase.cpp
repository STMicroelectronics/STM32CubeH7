    ...
    flexButtonCallback(this, &RecipeSelectedScreenViewBase::flexButtonCallbackHandler)
{
    ...
    imageDish.setXY(0, 0);
    imageDish.setBitmap(Bitmap(BITMAP_PASTE_BIG_BG_ID));
    ...
    textAreaIngredientAmount1.setTypedText(TypedText(T_SINGLEUSEID6));
    ...
    textAreaIngredientAmount2.setTypedText(TypedText(T_SINGLEUSEID7));
    ...
    textAreaIngredientAmount3.setTypedText(TypedText(T_SINGLEUSEID8));
    ...
    textAreaIngredientAmoun4.setTypedText(TypedText(T_SINGLEUSEID9));
    ...
    textAreaIngredientAmount5.setTypedText(TypedText(T_SINGLEUSEID10));
    ...
    textAreaIngredientAmount6.setTypedText(TypedText(T_SINGLEUSEID11));
    ...
    textAreaIngredientAmount7.setTypedText(TypedText(T_SINGLEUSEID12));
    ...
    textAreaIngredientAmount8.setTypedText(TypedText(T_SINGLEUSEID13));
    ...
    textAreaIngredientAmount9.setTypedText(TypedText(T_SINGLEUSEID14));
    ...
    textAreaIngredient1.setTypedText(TypedText(T_SINGLEUSEID15));
    ...
    textAreaIngredient2.setTypedText(TypedText(T_SINGLEUSEID16));
    ...
    textAreaIngredient3.setTypedText(TypedText(T_SINGLEUSEID17));
    ...
    textAreaIngredient4.setTypedText(TypedText(T_SINGLEUSEID18));
    ...
    textAreaIngredient5.setTypedText(TypedText(T_SINGLEUSEID19));
    ...
    textAreaIngredient6.setTypedText(TypedText(T_SINGLEUSEID20));
    ...
    textAreaIngredient7.setTypedText(TypedText(T_SINGLEUSEID21));
    ...
    textAreaIngredient8.setTypedText(TypedText(T_SINGLEUSEID22));
    ...
    textAreaIngredient9.setTypedText(TypedText(T_SINGLEUSEID23));
    ...
    textAreaIngredientHeadline.setTypedText(TypedText(T_SINGLEUSEID24));
    ...
    textAreaMethodHeadline.setTypedText(TypedText(T_SINGLEUSEID27));
    ...
    textAreaStep1Headline.setTypedText(TypedText(T_SINGLEUSEID28));
    ...
    textAreaStep1Directions.setTypedText(TypedText(T_SINGLEUSEID29));
    ...
    textAreaStep2Headline.setTypedText(TypedText(T_SINGLEUSEID30));
    ...
    textAreaStep2Directions.setTypedText(TypedText(T_SINGLEUSEID31));
    ...
    textAreaStep3Headline.setTypedText(TypedText(T_SINGLEUSEID32));
    ...
    textAreaStep3Directions.setTypedText(TypedText(T_SINGLEUSEID33));
    ...
    textAreaNutritionHeadline.setTypedText(TypedText(T_SINGLEUSEID34));
    ...
    textAreaNutritionValue1.setTypedText(TypedText(T_SINGLEUSEID35));
    ...
    textAreaNutritionValue2.setTypedText(TypedText(T_SINGLEUSEID36));
    ...
    textAreaNutritionValue3.setTypedText(TypedText(T_SINGLEUSEID37));
    ...
    textAreaNutritionValue4.setTypedText(TypedText(T_SINGLEUSEID38));
    ...
    textAreaNutritionValue5.setTypedText(TypedText(T_SINGLEUSEID39));
    ...
    textAreatextAreaNutritionType1.setTypedText(TypedText(T_SINGLEUSEID40));
    ...
    textAreatextAreaNutritionType2.setTypedText(TypedText(T_SINGLEUSEID41));
    ...
    textAreatextAreaNutritionType3.setTypedText(TypedText(T_SINGLEUSEID42));
    ...
    textAreatextAreaNutritionType4.setTypedText(TypedText(T_SINGLEUSEID43));
    ...
    textAreatextAreaNutritionType5.setTypedText(TypedText(T_SINGLEUSEID44));
