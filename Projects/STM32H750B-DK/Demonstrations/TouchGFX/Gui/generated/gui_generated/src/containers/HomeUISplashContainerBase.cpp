...
HomeUISplashContainerBase::HomeUISplashContainerBase()
{
    ...
    background.setBitmap(Bitmap(BITMAP_HOMECONTROL_UI_BG_ID));
    ...
    Unicode::snprintf(textAreaTempBuffer, TEXTAREATEMP_SIZE, "%s", TypedText(T_SINGLEUSEID111).getText());
    textAreaTemp.setWildcard(textAreaTempBuffer);
    textAreaTemp.resizeToCurrentText();
    textAreaTemp.setTypedText(TypedText(T_SINGLEUSEID59));
    ...
    textAreaTempUnit.setTypedText(TypedText(T_SINGLEUSEID60));
    ...
    textAreaHeadline.setTypedText(TypedText(T_HOMEUISPLASHBATHROOM));
    ...
    textAreaBottomline.setTypedText(TypedText(T_SINGLEUSEID110));
    ...
    textAreaWakeUp.setTypedText(TypedText(T_SINGLEUSEID62));
