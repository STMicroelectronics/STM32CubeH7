    ...
    flexButtonCallback(this, &KitchenScreenViewBase::flexButtonCallbackHandler)
{
    ...
    background.setBitmap(Bitmap(BITMAP_KITCHEN_UI_BG_ID));

    buttoHallway.setXY(2, 2);
    buttoHallway.setBitmaps(Bitmap(BITMAP_GO_BACK_BUTTON_ID), Bitmap(BITMAP_GO_BACK_BUTTON_ID));
    buttoHallway.setAction(buttonCallback);

    imageLight.setXY(0, 0);
    imageLight.setVisible(false);
    imageLight.setBitmap(Bitmap(BITMAP_LIGHTS_ON_ID));

    buttonExtractorHood.setXY(77, 0);
    buttonExtractorHood.setBitmaps(Bitmap(BITMAP_AIR_SELECT_ID), Bitmap(BITMAP_AIR_SELECT_ID));
    buttonExtractorHood.setAction(buttonCallback);
    buttonExtractorHood.setAlpha(0);

    buttonThermo.setXY(22, 68);
    buttonThermo.setBitmaps(Bitmap(BITMAP_TERMO_SELECT_ID), Bitmap(BITMAP_TERMO_SELECT_ID));
    ...
    imageCookpot.setBitmap(Bitmap(BITMAP_COOKPOT_ON_ID));

    imageOvenOn.setXY(375, 137);
    imageOvenOn.setVisible(false);
    imageOvenOn.setBitmap(Bitmap(BITMAP_OVEN_ON_ID));

    imageHoodUI.setXY(173, 8);
    imageHoodUI.setVisible(false);
    imageHoodUI.setBitmap(Bitmap(BITMAP_FAN_DISPLAY_ON_ID));

    imageHomeUI.setXY(43, 98);
    imageHomeUI.setVisible(false);
    imageHomeUI.setBitmap(Bitmap(BITMAP_RECIPIES_DISPLAY_ON_ID));

    imageOvenUI.setXY(415, 96);
    imageOvenUI.setVisible(false);
    imageOvenUI.setBitmap(Bitmap(BITMAP_OVEN_DISPLAY_ON_ID));
