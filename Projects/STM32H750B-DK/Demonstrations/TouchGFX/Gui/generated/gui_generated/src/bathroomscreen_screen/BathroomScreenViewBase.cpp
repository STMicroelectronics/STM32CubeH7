    ...
    buttonCallback(this, &BathroomScreenViewBase::buttonCallbackHandler)
{
    ...
    background.setBitmap(Bitmap(BITMAP_BATHROOM_BG_ID));

    buttonBack.setXY(0, 0);
    buttonBack.setBitmaps(Bitmap(BITMAP_GO_BACK_BUTTON_ID), Bitmap(BITMAP_GO_BACK_BUTTON_ID));
    buttonBack.setAction(buttonCallback);

    imageBathtubUI.setXY(235, 138);
    imageBathtubUI.setVisible(false);
    imageBathtubUI.setBitmap(Bitmap(BITMAP_BATHTUB_DISPLAY_ON_ID));

    buttonBathtub.setXY(84, 142);
    buttonBathtub.setBitmaps(Bitmap(BITMAP_BATHTUB_GLOW_ID), Bitmap(BITMAP_BATHTUB_GLOW_ID));
    buttonBathtub.setAction(buttonCallback);
    buttonBathtub.setAlpha(0);

    buttonWasher.setXY(360, 0);
    buttonWasher.setBitmaps(Bitmap(BITMAP_WASHING_MACHINE_GLOW_ID), Bitmap(BITMAP_WASHING_MACHINE_GLOW_ID));
    buttonWasher.setAction(buttonCallback);
    buttonWasher.setAlpha(0);

    buttonHomeControl.setXY(36, 57);
    buttonHomeControl.setBitmaps(Bitmap(BITMAP_HOMECONTROL_GLOW_ID), Bitmap(BITMAP_HOMECONTROL_GLOW_ID));
    ...
    imageBathtubWater.setBitmap(Bitmap(BITMAP_BATHTUB_WATER_ON_ID));

    imageWasherActive.setXY(389, 59);
    imageWasherActive.setVisible(false);
    imageWasherActive.setBitmap(Bitmap(BITMAP_WASHING_MACHINE_ON_ID));

    imageHomeUI.setXY(60, 83);
    imageHomeUI.setVisible(false);
    imageHomeUI.setBitmap(Bitmap(BITMAP_HOMECONTROL_DISPLAY_ON_ID));

    imageWasherUI.setXY(423, 17);
    imageWasherUI.setVisible(false);
    imageWasherUI.setBitmap(Bitmap(BITMAP_WASHING_MACHINE_DISPLAY_ON_ID));
