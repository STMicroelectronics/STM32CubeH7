    ...
    updateItemCallback(this, &RecipeScreenViewBase::updateItemCallbackHandler)
{
    ...
    background.setBitmap(Bitmap(BITMAP_MAIN_UI_BG_ID));

    topbar.setXY(0, 0);
    topbar.setBitmap(Bitmap(BITMAP_TOP_UI_BG_ID));
    ...
    scrollListRecipeSelector.setEasingEquation(EasingEquations::backEaseOut);
    ...
    tiledImageGradientTop.setBitmap(Bitmap(BITMAP_SCROLL_GRADIENT_OVERLAY_ID));
    tiledImageGradientTop.setPosition(0, 70, 480, 27);
    tiledImageGradientTop.setOffset(0, 0);

    tiledImageGradientBottom.setBitmap(Bitmap(BITMAP_SCROLL_GRADIENT_OVERLAY_ID));
...
void RecipeScreenViewBase::updateItemCallbackHandler(DrawableListItemsInterface* items, int16_t containerIndex, int16_t itemIndex)
{
