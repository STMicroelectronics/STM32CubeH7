    ...
    updateItemCallback(this, &HomeControlScreenViewBase::updateItemCallbackHandler)
{
    ...
    background.setBitmap(Bitmap(BITMAP_MAIN_BG_HOME_CONTROL_ID));
    ...
    scrollWheelRoomSelector.setEasingEquation(EasingEquations::backEaseOut);
    ...
    scrollWheelRoomInfo.setEasingEquation(EasingEquations::cubicEaseOut);
    ...
    scrollListKitchenDevices.setEasingEquation(EasingEquations::backEaseOut);
    ...
    scrollListBathroomDevices.setEasingEquation(EasingEquations::backEaseOut);
    ...
    radioButtonTemperature.setBitmaps(Bitmap(BITMAP_TEMPERATURE_NORMAL_ID), Bitmap(BITMAP_TEMPERATURE_NORMAL_ID), Bitmap(BITMAP_TEMPERATURE_SELECTED_ID), Bitmap(BITMAP_TEMPERATURE_SELECTED_ID));
    ...
    radioButtonDevices.setBitmaps(Bitmap(BITMAP_DEVICES_NORMAL_ID), Bitmap(BITMAP_DEVICES_NORMAL_ID), Bitmap(BITMAP_DEVICES_SELECTED_ID), Bitmap(BITMAP_DEVICES_SELECTED_ID));
    ...
    buttonPersonalize.setBitmaps(Bitmap(BITMAP_PESONALIZE_ID), Bitmap(BITMAP_PESONALIZE_ID));
    ...
    imageTopGradient.setBitmap(Bitmap(BITMAP_TOP_GRADIENT_OVERLAY_ID));
    ...
    buttonBack.setBitmaps(Bitmap(BITMAP_GO_BACK_BUTTON_PRESSED_ID), Bitmap(BITMAP_GO_BACK_BUTTON_PRESSED_ID));
    ...
    Unicode::snprintf(textAreaDateBuffer, TEXTAREADATE_SIZE, "%s", TypedText(T_SINGLEUSEID71).getText());
    textAreaDate.setWildcard(textAreaDateBuffer);
    textAreaDate.setTypedText(TypedText(T_SINGLEUSEID69));
    ...
    Unicode::snprintf(textAreaTimeBuffer, TEXTAREATIME_SIZE, "%s", TypedText(T_SINGLEUSEID72).getText());
    textAreaTime.setWildcard(textAreaTimeBuffer);
    textAreaTime.setTypedText(TypedText(T_SINGLEUSEID70));

    glowTemp.setXY(20, 187);
    glowTemp.setBitmap(Bitmap(BITMAP_SELECT_GLOW_ID));
    glowTemp.setAlpha(0);

    glowDevices.setXY(140, 187);
    glowDevices.setBitmap(Bitmap(BITMAP_SELECT_GLOW_ID));
    glowDevices.setAlpha(0);

    glowRecipe.setXY(260, 187);
    glowRecipe.setBitmap(Bitmap(BITMAP_SELECT_GLOW_ID));
...
void HomeControlScreenViewBase::radioButtonSelectedCallbackHandler(const touchgfx::AbstractButton& src)
{
    ...
    else if (&src == &radioButtonDevices)
    {
...
void HomeControlScreenViewBase::updateItemCallbackHandler(DrawableListItemsInterface* items, int16_t containerIndex, int16_t itemIndex)
{
