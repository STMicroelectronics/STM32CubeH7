...
In this application, two operating modes are available:
 ...
 2. Run-time application mode:
    This is the normal run-time activities. A binary which toggles LED1 on the NUCLEO-H7A3ZI-Q board is
...
@note A binary HID_Standalone on the NUCLEO-H7A3ZI-Q board is provided in Binary directory.
