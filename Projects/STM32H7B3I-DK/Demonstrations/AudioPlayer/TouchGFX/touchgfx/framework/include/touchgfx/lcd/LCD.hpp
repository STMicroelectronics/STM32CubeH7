...
public:
    ...
    */
     ...
     *
     * @param [in] pixelxAlpha The red and blue components of a 32bit ARGB pixel multipled by an
     *                         alpha factor.
     *
     ...
     *
     * @param [in] pixelxAlpha The green component of a 32bit ARGB pixel multipled by an alpha
     *                         factor.
     *
    ...
    {
        return ((pixelxAlpha + 0x100 + ((pixelxAlpha >> 8) & 0xFF00)) >> 8) & 0xFF00;
    }
...
{
public:
    DebugPrinter() : debugString(0), debugRegion(Rect(0, 0, 0, 0)), debugForegroundColor(colortype(0xffffffff)), debugScale(1) { }
