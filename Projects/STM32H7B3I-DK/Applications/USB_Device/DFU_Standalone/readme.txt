...
In this application, two operating modes are available:
 ...
 2. Run-time application mode:
    This is the normal run-time activities. This is the normal run-time activities. A binary which toggles LED1 on the STM32H7B3I-DISCO board is provided in Binary directory.
...
@note A binary HID_Standalone on the STM32H7B3I-DK board is provided in Binary directory.
